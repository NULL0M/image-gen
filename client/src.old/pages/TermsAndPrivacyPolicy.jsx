// client/src/pages/TermsAndPrivacyPolicy.jsx
  ...
  return (
    <div className='termsandprivacypolicy'>
      <main className='main2'>
        <Header />
        <section className='termsconainer'>
          <h2 className='terms-and-privacy-title'>Terms and Privacy Policy</h2>
          <section className='terms-and-privacy-content'>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Image Ai
                  Generator.
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Image Ai Generator,
                  accessible from{' '}
                  <a
                    href='www.imageaigenerator.com'
                    rel='external nofollow noopener'
                    target='_blank'>
                    www.imageaigenerator.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: teste@teste.com</li>
            </ul>
          </section>
        </section>
      </main>
